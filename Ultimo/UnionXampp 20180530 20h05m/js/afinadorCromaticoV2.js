...
function comprobadorFrecuencia(numeroComprobacion, numeroComprobador){
	...
	if (numeroComprobacion == numeroComprobador){

		return true;

	}else if(numeroComprobacion == numeroComprobador+1){
...
/*
	if ((numeroComprobacion - numeroComprobador) <= 2){

		return true;

	}else if ((numeroComprobador - numeroComprobacion ) <= 2){
