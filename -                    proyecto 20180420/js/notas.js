...
Notas.prototype.pintaSemitono = function(){
	...
	var semitonoNota = this.canvas.text(semitono).move(posicionX, posicionY).font({ fill: "#ffffff", family: 'Inconsolata', size: 10})
...
Notas.prototype.semitonoPosicionX = function(linea){
	...
	var posicionNumerosX = [785, 785, 785, 785, 785, 785, 785];
...
Notas.prototype.semitonoPosicionY = function(linea){
	...
	var posicionNumerosY = [25, 75, 125, 175, 225, 275, 325];
