suite('FrequenciesExtractor', function() {
    ...
    // Los valores reales aquí deben ser 1024 posiciones Uint8Arrays, el valor de esta prueba básicamente es para saber si el comportamiento del método cambia.
    var testCases = [
