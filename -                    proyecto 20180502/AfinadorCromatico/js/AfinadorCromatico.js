...
Mirar para que es esta formula:
...
AfinadorCromatico.prototype.autoCorrelate = function( buffer, sampleRate ) {
...
f			var shift = (correlations[best_offset+1] - correlations[best_offset-1])/correlations[best_offset];  
...
AfinadorCromatico.prototype.actualizarAfinador = function() {
	...
	var afinador = this.autoCorrelate( buffer, audioContext.sampleRate );
